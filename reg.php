    ...
    <div class="container mt-5">
        ...
        <div class="card-body">
            ...
            class="form-control" id="exampleInputEmail1" required aria-describedby="emailHelp">
               ...
               <div class="row">
                    <div class="col-md-6">
                       <label for="exampleInputEmail1" class="form-label mt-2">Age</label>
                       <input type="number" placeholder="Enter your age" name="age"  min="1" max="120" title="Enter a valid age" class="form-control" id="exampleInputEmail1" required aria-describedby="emailHelp">
                    </div>

                   <div class="col-md-6">
                       <label for="exampleInputEmail1" class="form-label mt-2">Date of Birth</label>
                       <input placeholder="Enter your date of birth" class="form-control" required class="textbox-n" type="text" onfocus="(this.type='date')" id="date" name="dob">
                    </div>
