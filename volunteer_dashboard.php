...
<header class="container-fluid" style="position:fixed;z-index: 1;background-color: #d4418e;
                            ...
                            <ul class="navbar-nav">
                              ...
                              <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                      ...
                                      <li><a class="dropdown-item" href="vol_profile.php?email=<?= $_SESSION['username']; ?>"><i class="bi bi-person-fill"></i> My profile</a></li>
      ...
      <div class="row">
            <div class="col-md-4 animate__animated animate__backInLeft ">
              <div class="card text-center p-3 "  style="background-color: #DFECFB">
                ...
                <div class="card-body">
                  ...
                  <a href="upload_photo.php" class="btn btn-primary mt-3 " >View here</a>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-4  animate__animated animate__backInDown animate__delay-2s"> 
              <div class="card text-center p-3" style="background-color: #DFECFB">
                ...
                <!--icon -->
                <div class="card-body">
                  <h5 class="card-title">Works assigned</h5>
                  <!-- <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p> -->
                  <a href="my_works.php" class="btn btn-primary mt-3">View here</a>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-4  animate__animated animate__backInRight animate__delay-1s">
              <div class="card text-center p-3 "style="background-color:  #DFECFB " >
                ...
                <div class="card-body">
                  ...
                  <!-- <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p> -->
                  <a href="rules.html" class="btn btn-primary mt-3">View here</a>
                </div>
              </div>
            </div>
      </div>
